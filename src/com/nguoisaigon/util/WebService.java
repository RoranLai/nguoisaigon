...
public class WebService extends AsyncTask<String, Void, JSONObject> {
	...
	public enum productCategory {
		cat_fashion_man("cat_fashion_man", 0),
		cat_fashion_woman("cat_fashion_woman", 1),
		cat_fashion_kid("cat_fashion_kid", 2),
		cat_cos_man("cat_cos_man", 3),
		cat_cos_woman("cat_cos_woman", 4),
		cat_food("cat_food", 5),
		cat_lifeStyle("cat_lifeStyle", 6);
	...
	public enum productSearchType {
		search_for_client("search_for_client", 0),
		search_for_admin("search_for_admin", 1);
	...
	/**
	 * true if the request that sends to server is a Post request. Default is false. 
	 */
